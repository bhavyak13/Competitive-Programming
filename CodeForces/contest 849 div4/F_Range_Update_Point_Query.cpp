...
bool cmp1(const pair<int, int> &i1, const pair<int, int> i2)
{
...
struct cmp
{
    constexpr bool operator()(pi const &a, pi const &b) const noexcept { return a.first > b.first; }
};
#define ai array<int, 2>
struct cmparr
{
    constexpr bool operator()(ai const &a, ai const &b) const noexcept { return a[0] > b[0]; }
};
...
// seg tree code taken from here : https://usaco.guide/problems/cses-1651-range-update-queries/solution
