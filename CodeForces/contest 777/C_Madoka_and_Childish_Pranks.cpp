...
//             if(a[i][j]==0)continue;
//             array<int,4>t;
//             if(j-1>=0&&a[i][j-1]==0){t[0]=t[2]=i;t[1]=j-1;t[3]=j;ans.pb(t);}
//             else if(j+1<m&&a[i][j+1]==0){t[0]=t[2]=i;t[1]=j;t[3]=j+1;ans.pb(t);}
//             else if(i-1>=0&&a[i-1][j]==0){t[1]=t[3]=j;t[1]=i-1;t[3]=i;ans.pb(t);}
//             else if(i+1<n&&a[i+1][j]==0){t[1]=t[3]=j;t[1]=i;t[3]=i+1;ans.pb(t);}
//             else {pn(-1);return;}
//         }
//     }
//     pn(ans.sz);
