...
int wiggleMaxLength(vector<int>& nums) {
    int n=nums.size();
    // dp[i] -> longest subsequence considering ith element as last elemnt of wiggle & ending with a raising wiggle.
    // dp2[i] -> longest subsequence considering ith element as last elemnt of wiggle & ending with a failing wiggle.
    vector<int> dp(n+1,0);
