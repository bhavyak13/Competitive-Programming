...
void solve()
{
    ...
    ffor(i,0,n){
        ...
        int y1=y;
        while(true){
            if(mpp[mp(x,arr[i].ss)]==0){
                pt2(x,arr[i].ss);break;
            }
            else if(mpp[mp(x1,arr[i].ss)]==0){
                pt2(x1,arr[i].ss);break;
            }
            else if(mpp[mp(arr[i].ff,y)]==0){
                pt2(arr[i].ff,y);break;
            }else if(mpp[mp(arr[i].ff,y1)]==0){
                pt2(arr[i].ff,y1);break;
            }
            x1--;x++;
            y1--;y++;
        }
